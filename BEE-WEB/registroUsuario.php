        ...
        <div class="row py-5" style="background-color: #f2f2f2;" style="position: relative;">
            ...
            <form class="col-md-9 m-auto" method="post" role="form" action="" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control mt-1" id="ubicacion" name="ubicacion" placeholder="Ubicacion" style="border: 1px solid black">
                </div>
                <div class="row text-center py-3">
                    <div class="col-lg-6 m-auto">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnCreaCliente').click(function(event){
                ...
                const ubicacionCliente=$('#ubicacion').val();
                
                $.post('assets/scripts/altaCliente.php', {
                    correo: correo, clave: clave, nombreCliente: nombreCliente, contraCliente: contraCliente, ubicacionCliente: ubicacionCliente}, function(response) {
                    try {
