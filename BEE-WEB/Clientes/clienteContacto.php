...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            ...
            <p>
                Para poder comunicarte con nosotros, aquí se encuentra la ubicación de nuestra tienda física y un formulario para contactar con nosotros por medio de tu correo
            </p>
        </div>
    </div>
    ...
    -->
    <div id="mapa">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3695.498870618506!2d-100.975581624712!3d22.14507467979854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842aa3facdeb255b%3A0x8975ace6745b8fb2!2sInstituto%20Mexicano%20de%20Apicultura!5e0!3m2!1ses!2smx!4v1728765047097!5m2!1ses!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <!-- Ena Map -->
            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="Name" value="<?php echo "$nombreCliente" ?>" disabled style="border: 1px solid black">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Correo</label>
                        <input type="email" class="form-control mt-1" id="email" name="email" placeholder="Email" value="<?php echo "$correoCliente" ?>" disabled style="border: 1px solid black"> 
                    </div>
                </div>
                <div class="mb-3">
                    <label for="inputsubject">Asunto</label>
                    <input type="text" class="form-control mt-1" id="subject" name="subject" placeholder="Asunto" style="border: 1px solid black">
                </div>
                <div class="mb-3">
                    <label for="inputmessage">Mensaje</label>
                    <textarea class="form-control mt-1" id="message" name="message" placeholder="Mensaje" rows="8" style="border: 1px solid black; resize: none"></textarea>
                </div>
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3" id="btnContacto" style='color: #000'>Enviar</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnContacto').click(function(event){
                ...
                const usuario=$('#name').val();
                const correo=$('#email').val();
                const asunto=$('#subject').val();
                const msj=$('#message').val();
                //console.log(usuario);
                $.post('../assets/scripts/contacto.php',{
                    usuario:usuario,correo:correo,asunto:asunto,
                    msj:msj},function(response){
                    console.log('Respuesta del servidor',response);
                    var data=JSON.parse(response);
                    if(data.success){
                        alert('Se ha mandado el correo de manera correcta');
                        location.reload();
                    }else{
