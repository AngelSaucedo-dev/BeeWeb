        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-12 text-white" >
                    <h1 style='color: #000'>Acerca de nosotros</h1>
                    <p style='color: #000'>
                        Bee-web es un sitio web para la tienda del Instituto Mexicano de Apicultura (IMA), que es una organización encargada de vender productos del sector apícola, 
                        en los que destacan productos como dulces, cera de abeja y material apícola.
                    </p>
                </div>
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    A continuación se presentan nuestros servicios con los que cuenta la página Bee-web
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                <div class="h1 text-success text-center"><i class="fa fa-dollar-sign"></i></div>
                <h2 class="h5 mt-4 text-center">Compra de productos</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">Carrito de compras</h2>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Búsqueda de productos</h2>
                </div>
            </div>
