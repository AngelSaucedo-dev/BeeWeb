    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="row" style="margin-bottom: 100px;">
                <div class="InfoTra">
                    <table>
                        ...
                        <tr>
                            <td class="tabTi"><i class="fa fa-map-marker-alt mx-2"></i>Ubicacion</td>
                            <td><?php echo $datosCliente['ubicacionCliente'] ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="col-md-6 m-auto text-center">
                <h1 class="h1">Mi historial de compra</h1>
            </div>
            <?php
                $link1=null;
                        ...
                        <tbody>
                            <?php
                                while($row=mysqli_fetch_array($query1)){
                                    $prod=$row['productoCompra'];
                                    $cant=$row['cantidadCompra'];
                                    $precio=$row['costoCompra'];
                                    $fecha=$row['fechaCompra'];
                                    $img=$row['imgCompra'];
                                    $destino="../assets/imgCompras/".$nombreUsuario."/".$img;
                            ?>  
                            <tr>
                                <td><?php echo "$prod" ?></td>
                                <td><?php echo $cant ?></td>
                                ...
                                <td><img src="<?php echo "$destino" ?>" alt="imagenCompra" style="height: 60px; object-fit: cover;"></td>
                            </tr>
                            <?php
                                }
                            ?>
            ...
            <?php
                ...
                /*<div class="col-md-6 m-auto text-center">
                    <h2>Todavia no se han realizado compras</h1>
                </div>*/
            }
            ?>
        </div>
